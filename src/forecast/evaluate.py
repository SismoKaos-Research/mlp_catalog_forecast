...
from forecast.metrics import binary_report, print_report, safe_auc
...
def fold_result(label, y_true, ensemble_score, per_seed_scores, train_labels,
                ...
                rate_trailing_train=None, quiet=False):
    ...
    if not quiet:
        ...
        print_report(f"catalog_mlp ensemble ({label}, test set)", report)
